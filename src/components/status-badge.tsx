  ...
  return (
    <span
      ...
      style={{
        ...
        borderColor: `color-mix(in oklab, ${colors[severity]} 35%, transparent)`,
        backgroundColor: `color-mix(in oklab, ${colors[severity]} 10%, transparent)`,
      }}
    >
...
export function RiskChip({ risk }: { risk: RiskFlag }) {
  ...
  const isCritical =
    risk === "possible_manipulation" ||
    risk === "text_instruction_present" ||
